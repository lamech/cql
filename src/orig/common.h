...
const char SCID_VERSION_STRING[] = "3.4";     // Current Scid version
const char SCID_VERSION_DATE[] = "January 2003";
...
inline int gzread (gzFile fp, void * buffer, int length) { return 0; }
