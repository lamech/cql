...
Index::Open (fileModeT fmode, bool old)
{
    ...
    FileMode = fmode;
    //    char * modeStr; commented out by stiller 11/12/2022 to suppress warning
    switch (fmode) {
        case FMODE_ReadOnly:
	  /*modeStr = "rb";*/ break; //commented out by stiller 11/12/2022 to suppress warning
        case FMODE_WriteOnly:
	  /*modeStr = "wb";*/ break; //commented out by stiller 11/12/2022 to suppress warning
        case FMODE_Both:
	  /*modeStr = "r+b"*/; break; //commented out by stiller 11/12/2022 to suppress warning
        default:
