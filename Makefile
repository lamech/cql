...
#matefunction.o: matefunction.cpp matefunction.h ${MYHEADERS}
#	$(COMPILE) ${CPP_FLAGS} -o $@ -c $<

orig/tree.o:
	$(MAKE) -C ./orig origstuff
#testpieceloc:	${MYOBJS} ${ORIGOBJS} testpieceloc.o ${MYHEADERS}
#	${COMPILE} ${CPP_FLAGS} ${MYOBJS} testpieceloc.o -o testpieceloc

#testtoken:	${MYOBJS} ${ORIGOBJS} testtoken.o ${MYHEADERS}
#	${COMPILE} ${CPP_FLAGS} ${MYOBJS} ${ORIGOBJS} testtoken.o -o testtoken
